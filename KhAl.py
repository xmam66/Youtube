...
RRRQS = Client(
   "Youtube Bot",
   api_id=Config.1914380,
   api_hash=Config.431619710372ffa3fe8ee09dfec68935,
   bot_token=Config.5012340187:AAGGzPm1y1kw4YJN3HgI6EhYbCOjrMFbW4U,
)
...
@RRRQS.on_message(filters.private
                   & filters.text
                   & ~filters.edited
        ...
        try:
            ...
            await c.send_message(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("القناة ", url=f"https://t.me/KKKNUN")
                        ]
                    ]
                ),
                parse_mode="markdown"
            ...
            await c.send_message(
                chat_id=message.chat.id,
                text="هنالك شي خطا تواصل مع مطوري [اضغط هنا](https://t.me/RRRQS).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
